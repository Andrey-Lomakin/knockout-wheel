...
- 🎡 **Колесо на canvas** — сектор рисуется пропорционально весу участника (×1…×3, шаг 0.2).
- 🔥 **Раунд на выбывание** — каждый спин кого-то выбивает; раунд идёт до единственного выжившего.
- ⚖️ **Вес ×1…×3 (шаг 0.2)** — степпером в строке: больший вес = шире сектор, выше шанс вылететь.
