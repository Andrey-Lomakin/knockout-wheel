...
- 🎡 **Колесо на canvas** — сектор рисуется пропорционально шансу вылететь: чем выше множитель, тем уже сектор.
- 🔥 **Раунд на выбывание** — каждый спин кого-то выбивает; раунд идёт до единственного выжившего.
- 📣 **Карточка выбывания** — кто вылетел, всплывает над колесом; его сектор гаснет и держится до следующего спина.
- 🍀 **Множитель шанса ×1…×3 (шаг 0.2)** — степпером в строке. Работает буквально: доля сектора
  обратна множителю (`1 / вес`), то есть у ×2 сектор **ровно вдвое уже** обычного и вдвое меньший
  шанс вылететь на каждом спине.
...
- ⏱️ **Длительность спина** — 3 / 5 / 10 / 15 секунд.
...
- 💾 **localStorage** — переживает перезагрузку **только состав и ✋/🙈** (имя + включён ли человек).
  Множители, выбывшие и медали — нет: это состояние текущего раунда.
